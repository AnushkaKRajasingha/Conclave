...
$route['disconnectfriend/(:num)'] = 'connections/disconnect/$1';
$route['connectfriend/(:num)'] = 'connections/connect/$1';
$route['acceptfriend/(:num)'] = 'connections/acceptfriend/$1';

$route['posts/(:num)'] = 'posts/edit/$1';
